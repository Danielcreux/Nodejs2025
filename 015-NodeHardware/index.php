...
$nodePath = 'C:\\Program Files\\nodejs\\node.exe'; // Verifica la ruta con `which node`

// Ruta del script de Node.js
$scriptPath = 'C:\\xampp\\htdocs\\Nodejs2025\\015-NodeHardware\\002-guardargraficas.js'; // Evita espacios en nombres de archivos
...
set_time_limit(600); // Aumenta el tiempo máximo a 5 minutos
...
<head>
    ...
    <title>Danielcreux| NewTomato - System Monitoring</title>
    <style>
        /* Estilos CSS */
        body {
...
<header>Danielcreux | NewTomato - System Monitoring</header>
...
<div class="footer">Powered by Danielcreux | NewTomato</div>
